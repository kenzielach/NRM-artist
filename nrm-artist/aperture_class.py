...
class aperture: 
    ...
    def __init__(self, tn='null'):#, t_info=[]):
        ...
        if tn == 'keck':
            ...
            self.file = pyfits.getdata('/Users/kenzie/Desktop/NRM-artist/NRM-artist/nrm-artist/keck_aperture.fits')
            self.hcmb_coords = np.loadtxt('/Users/kenzie/Desktop/NRM-artist/NRM-artist/nrm-artist/vcoords_keck9hole.txt') # honeycomb coords
